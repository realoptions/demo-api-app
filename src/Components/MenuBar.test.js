...
describe('render', ()=>{
    it('renders', ()=>{
        const m=mount(<Provider store={store}><MenuBar options={['hello']}/></Provider>)
...
describe('functionality', ()=>{
    ...
    it('menu has the 3 models', ()=>{
        ...
        const m=mount(<Provider store={store}><MenuBar options={options}/></Provider>)
        m.find(IconButton).at(1).simulate('click')
